			...
			state_operations=[
				migrations.CreateModel(
					...
					fields=[
						...
						('name', models.CharField(help_text='Name of the achievement', max_length=128)),
						(
							'image',
							models.ImageField(
								blank=True,
				...
				migrations.CreateModel(
					...
					fields=[
						...
						('name', models.CharField(help_text='The name of the level', max_length=128)),
					],
					options={
				...
				migrations.CreateModel(
					...
					fields=[
						...
						(
							...
							models.CharField(
								choices=[
									('PR', 'Pull request'), ('BR', 'Bug report'), ('WK', 'Wiki bonus'),
									('US', 'USEMO Score'), ('UG', 'USEMO Grading'), ('MS', 'Miscellaneous')
								],
								default='MS',
								max_length=4
							)
				...
				migrations.CreateModel(
					...
					fields=[
						...
						(
							'hyperlink',
							models.URLField(blank=True, help_text='An external link of your choice')
						),
						(
							'visible',
							models.BooleanField(
