...
class UploadedFile(models.Model):
	...
	CHOICES = (("psets", "PSet Submission"), ("scripts", "Transcript"), ("notes",
		"Notes / Comments"), ("misc", "Miscellaneous"))
...
class PSet(models.Model):
	...
	clubs = models.IntegerField(help_text=
...
class ProblemSuggestion(models.Model):
	...
	weight = models.PositiveSmallIntegerField(choices=((2, 2), (3, 3), (5, 5), (9,
		9)),
		null=True,
		blank=True)
