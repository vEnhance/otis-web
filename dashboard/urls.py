...
urlpatterns = [
	...
	path(
		r'achievements/<int:student_id>/', views.achievements, name='achievements'
	),
	path(
		r'achievements/listing/',
		views.AchievementList.as_view(),
		name='achievements-listing'
	),
	path(r'foundlist/<int:pk>/', views.FoundList.as_view(), name='found-listing'),
	path(
		r'uploads/<int:student_id>/<int:unit_id>/', views.uploads, name='uploads'
	),
	...
	path(
		r'suggest/<int:student_id>/<int:unit_id>/new/',
		views.ProblemSuggestionCreate.as_view(),
		name='suggest-new'
	),
	path(
		r'suggest/<int:pk>/edit/',
		views.ProblemSuggestionUpdate.as_view(),
		name='suggest-update'
	),
	path(
		r'suggest/<int:student_id>/list/',
		views.ProblemSuggestionList.as_view(),
		name='suggest-list'
	),
	path(
		r'suggest/resolve/', views.pending_contributions, name='pending-suggest'
	),
	path(
		r'suggest/resolve/<int:suggestion_id>/',
		views.pending_contributions,
		name='resolve-suggest'
	),
