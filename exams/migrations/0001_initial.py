    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family',
                    models.CharField(
                        choices=[('Waltz', 'Waltz'), ('Tango', 'Tango'),
                                    ('Foxtrot', 'Foxtrot')],
                ...
                ('jmo_url',
                    models.CharField(
                        blank=True, help_text='The URL to the JMO problems', max_length=120)),
                ('usamo_url',
                    models.CharField(
                        blank=True, help_text='The URL to the USAMO problems', max_length=120)),
                ('solns_url',
                    models.CharField(
