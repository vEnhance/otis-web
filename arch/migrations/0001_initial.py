        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "problem_source",
                    models.CharField(
                        help_text="The source of the problem, such as `TSTST 2020/3`.If in doubt on formatting, follow what is written on the handout.If the problem does not include a source, do your bestto write a two or three word description of the problemthat can be recognized, like `100 sleepy students` or `sloth blocking ruler`.",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="A list of keywords that a solver could look at to help them guess whether the hint is relevant or not. These are viewable immediately, so no spoilers here.",
                        max_length=255,
                    ),
                ),
                (
