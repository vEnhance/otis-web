    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                default="",
                help_text="A comma-separated list of keywords that a solver could look at to help them guess whether the hint is relevant or not. These are viewable immediately, so no spoilers here. Examples are `getting started`, `solution set`,`converse direction`, `construction`, etc. Not all problems go well with keywords, so you can leave this blank if you can't think of anything useful to write.",
                max_length=255,
            ),
        ),
    ]
