    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.FloatField(help_text="User's guess", validators=[django.core.validators.MinValueValidator(0.01, message='Need to enter a number at least 0.01.')])),
                ('score', models.FloatField(help_text='The score for the guess, computed by the backend.')),
                ('public', models.BooleanField(help_text='If checked, will display your name next to your guess in the statistics, for bragging rights. By default, this is off and your guess is recorded anonymously.')),
