...
def test_preprocessor():
    ...
    assert r'Alice says, "you are a doofus".' in reply
    ...
    assert r"<tr><th>Classification</th><td>Miscellaneous</td></tr>" in reply
    assert r"<tr><th>Slug</th><td>example</td></tr>" in reply
    assert r"<tr><th>Versions</th><td>DMW</td></tr>" in reply
