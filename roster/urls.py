...
urlpatterns = [
	...
	path(r'inquiry/edit/<int:pk>/',
				views.EditInquiry.as_view(),
				name='edit-inquiry'),
	path(r'inquiry/approve/<int:pk>/',
				views.approve_inquiry,
				name='approve-inquiry'),
	path(r'inquiry/approve/all/',
				views.approve_inquiry_all,
				name='approve-inquiry-all'),
	path(r'register/', views.register, name='register'),
	path(r'profile/', views.update_profile, name='update-profile'),
	path(r'mystery_unlock/easier/',
				views.unlock_rest_of_mystery,
				kwargs={'delta': 1}),
	path(r'mystery_unlock/harder/',
				views.unlock_rest_of_mystery,
				kwargs={'delta': 2}),
