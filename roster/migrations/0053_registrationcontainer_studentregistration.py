    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passcode',
                    models.CharField(
                        help_text="The passcode for that year's registration", max_length=128)),
                ('semester',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name',
                    models.CharField(
                        help_text=
                        'Enter your full name in American format (given name followed by family name). Middle name is optional.',
                        max_length=192)),
                ('email',
                    models.EmailField(
                        help_text=
                        'The email address. Please choose an email you check frequently because all future email communication will be sent to this address.',
                        max_length=254)),
                ('parent_email',
                    models.EmailField(
                        help_text=
                        'An email address in case Evan needs to contact your parents or something.',
                        max_length=254)),
                ('track',
                    models.CharField(
                        choices=[('C', 'Correspondence'),
                                    ('E', 'Meeting with another instructor'),
                                    ('B', 'Meeting with Evan'), ('N', 'None of the above')],
                        max_length=6)),
                ('gender',
                    models.CharField(
                        choices=[('M', 'Male'), ('F', 'Female'), ('H', 'Nonbinary'),
                ...
                ('grade_level',
                    models.IntegerField(
                        choices=[(13, 'Already graduated high school'),
                                    (12, 'Graduating in 2022'), (11, 'Graduating in 2023'),
                                    (10, 'Graduating in 2024'), (9, 'Graduating in 2025'),
                                    (8, 'Graduating in 2026'), (7, 'Graduating in 2027'),
                                    (6, 'Graduating in 2028'), (5, 'Graduating in 2029')],
